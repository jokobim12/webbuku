...
<aside class="fixed inset-y-0 left-0 w-64 bg-white border-r border-gray-200 z-30 transition-transform duration-300 transform -translate-x-full md:translate-x-0" id="sidebar">
    ...
    <nav class="p-4 space-y-1 overflow-y-auto h-[calc(100vh-4rem)]">
        ...
        <a href="/page/user/relasi.php" class="flex items-center px-4 py-3 rounded-lg font-medium transition-colors <?php echo isActive('relasi.php'); ?>">
            <svg class="w-5 h-5 mr-3 <?php echo getIconColor('relasi.php'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
            Jaringan
        </a>
